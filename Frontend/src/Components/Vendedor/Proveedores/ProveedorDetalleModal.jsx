            ...
            >
                ...
                <div className={styles.modalBody}>
                        ...
                        <div className={styles.cardHeader}>
                            <div>
                                ...
                                <p className={styles.muted}>
                                    Datos básicos del proveedor y su estado
                                    actual.
                                </p>
                            </div>
                            <span
                    ...
                    <div className={styles.actionsRow}>
                        <button
                            type="button"
                            className={`${styles.button} ${tab === "productos" ? styles.buttonPrimary : styles.buttonGhost}`}
                        ...
                        <button
                            type="button"
                            className={`${styles.button} ${tab === "compras" ? styles.buttonPrimary : styles.buttonGhost}`}
                        ...
                        <button
                            type="button"
                            className={`${styles.button} ${tab === "historial" ? styles.buttonPrimary : styles.buttonGhost}`}
                        ...
                        <section className={styles.card}>
                            <div className={styles.cardHeader}>
                                <div>
                                    ...
                                    <p className={styles.muted}>
                                        Productos que ya han sido comprados con
                                        este proveedor.
                                    </p>
                                </div>
                                <span
                                    ...
                                    {productos.map((producto) => (
                                        ...
                                        >
                                            <div className={styles.cardHeader}>
                                                ...
                                                <span
                                                    className={`${styles.badge} ${producto.activo ? styles.badgeActive : styles.badgeInactive}`}
                                                >
                                                    {producto.activo
                                                        ? "Activo"
                                                        : "Inactivo"}
                        ...
                        <section className={styles.card}>
                            <div className={styles.cardHeader}>
                                <div>
                                    ...
                                    <p className={styles.muted}>
                                        Historial de facturas y estados
                            ...
                            {compras.length === 0 ? (
                                ...
                                >
                                    ...
                                    <p>
                                        Cuando se creen compras para este
                                        proveedor aparecerán aquí.
                                    </p>
                                </div>
                            ) : (
                                            ...
                                            {compras.map((compra) => (
                                                <tr key={compra.id_compra}>
                                                    ...
                                                    <td data-label="Recepción">
                                                        <span
                                                            className={`${styles.badge} ${compra.estado_recepcion === "completa" ? styles.badgeActive : styles.badgeWarning}`}
                                                        >
                                                            {
                                                    ...
                                                    <td data-label="Pago">
                                                        <span
                                                            className={`${styles.badge} ${compra.estado_pago === "pagada" ? styles.badgeActive : compra.estado_pago === "parcial" ? styles.badgeWarning : styles.badgeInactive}`}
                                                        >
                                                            {compra.estado_pago}
                                                        </span>
                                                    </td>
                        ...
                        <section className={styles.card}>
                            <div className={styles.cardHeader}>
                                <div>
                                    ...
                                    <p className={styles.muted}>
                                        Consulta el precio pedido y recibido por
                                        producto y fecha.
                                    </p>
                                </div>
                                <span
                            ...
                            {historial.length === 0 ? (
                                ...
                                >
                                    ...
                                    <p>
                                        Las compras recibidas poblarán esta
                                        sección.
                                    </p>
                                </div>
                            ) : (
                                <div className={styles.tableWrap}>
                                    <table className={styles.table}>
                                        ...
                                        <tbody>
                                            {historial.map((fila) => (
                                                <tr
                                                    key={`${fila.id_detalle_compra}-${fila.id_compra}`}
                                                >
